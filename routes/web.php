...
Route::prefix('admin')->name('admin.')->middleware('isAdmin')->group(function(){
    ...
    // MAKALE ROUTE'S
    Route::get('makaleler/silinenler','App\Http\Controllers\Back\ArticleController@trashed')->name('trashed.new');
    ...
    Route::get('/deletenew/{id}','App\Http\Controllers\Back\ArticleController@delete')->name('delete.new');
    Route::get('/harddeletenew/{id}','App\Http\Controllers\Back\ArticleController@hardDelete')->name('hard.delete.new');
    Route::get('/recovernew/{id}','App\Http\Controllers\Back\ArticleController@recover')->name('recover.new');
    // CATEGORY ROUTE'S
    ...
    //
    Route::get('cıkıs','App\Http\Controllers\Back\AuthController@logout')->name('logout');
});
...
Route::get('/İletişim','App\Http\Controllers\Front\Homepage@contact')->name('contact');
Route::post('/İletişim','App\Http\Controllers\Front\Homepage@contactpost')->name('contact.post');
