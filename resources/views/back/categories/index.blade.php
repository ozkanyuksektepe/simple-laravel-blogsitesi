                            ...
                            @foreach($categories as $category)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a category-id="{{$category->id}}" category-name="{{$category->name}}" category-count="{{$category->newsCount()}}" class="btn btn-sm btn-danger remove-click" title="Kategoriyi Sil"><i class="fa fa-times text-white"></i> </a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
    ...
    <script>
        $(function() {
            $('.remove-click').click(function() {
                ...
                if(id==1){
                    $('#newsAlert').html(name+' Kategorisi Sabit Kategoridir. Silinen diğer kategorilere ait makaleler bu kategoriye eklenecektir.');
                    $('#body').show();
                    $('#deleteButton').hide();
                    $('#deleteModal').modal();
                    return;
                ...
                $('#body').hide();
                if(count>0){
                    $('#newsAlert').html('Bu Kategoriye ait '+count+' makale bulunmaktadır. Silmek istediğinize emin misiniz ?');
                    $('#body').show();
                }
                $('#deleteModal').modal();
            });
